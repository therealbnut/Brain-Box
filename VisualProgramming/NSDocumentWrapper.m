 ...
 */
//static NSString * const kStoreFileName = @"data.xml";

@implementation NSDocumentWrapper
...
//{
//    filePath = [filePath stringByAppendingPathComponent: kStoreFileName];
//    if (filePath != nil)
//	{
...
//    NSFileWrapper *dataStore = [[directoryFileWrapper fileWrappers] objectForKey: kStoreFileName];
//    if (dataStore != nil)
//	{
...
//	{
        ...
        success = [self readFromFileWrapper:directoryFileWrapper
